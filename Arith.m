function varargout = Arith(varargin)
...
% Last Modified by GUIDE v2.5 26-Oct-2022 20:28:23
...
set(handles.mul,'enable','off')
set(handles.add,'enable','off')
set(handles.sub,'enable','off')
set(handles.div,'enable','off')
set(handles.CALCY,'enable','off')
set(handles.sbrac,'enable','off')
set(handles.ebrac,'enable','off')
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.mul,'enable','on')
set(handles.add,'enable','on')
set(handles.sub,'enable','on')
set(handles.div,'enable','on')
set(handles.percent,'enable','on')
set(handles.sbrac,'enable','on')
set(handles.ebrac,'enable','on')
set(handles.CALCY,'enable','on')
...
% --- Executes on button press in sbrac.
function sbrac_Callback(hObject, eventdata, handles)
% hObject    handle to sbrac (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in ebrac.
function ebrac_Callback(hObject, eventdata, handles)
% hObject    handle to ebrac (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in CALCY.
function CALCY_Callback(hObject, eventdata, handles)
% hObject    handle to CALCY (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.out,'visible','on')
...
switch Selector
    ...
    set(handles.r, 'string',num2str(A));
    case 2
    B= B/str2num(get(handles.screen, 'string'));
    set(handles.r, 'string',num2str(B));
    case 3
    C= C/str2num(get(handles.screen, 'string'));
    set(handles.r, 'string',num2str(C));
    case 4
    D= D/str2num(get(handles.screen, 'string'));
    set(handles.r, 'string',num2str(D));
end